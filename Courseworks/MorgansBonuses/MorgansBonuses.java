 ...
 * This program allows user to continuously select the number of worked weeks and positive reviews
 * to see an appropriate bonus.
 */
...
class MorgansBonuses
{
   ...
   {
	  // set an appropriate bonus for each condition
      double[][] bonuses = 
         { { 5, 9, 16, 22, 30},
           {10, 12, 18, 24, 36},
           {20, 25, 32, 42, 53},
